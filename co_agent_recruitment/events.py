...
class EventPayload(BaseModel):
    ...
    session_id: str = Field(
        ..., description="The session ID associated with the event."
    )
...
class ParseJobPostingEvent(EventPayload):
    ...
    job_posting_data: JobPosting = Field(
        ..., description="The structured job posting data."
    )
...
class CompatibilityScoreEvent(EventPayload):
    ...
    compatibility_data: CompatibilityScore = Field(
        ..., description="The compatibility score data."
    )
