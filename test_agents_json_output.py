...
async def main():
    ...
    # Summary
    print("\n📊 Summary:")
    print(f"Resume parsing: {'✅ Success' if resume_result and 'error' not in resume_result else '❌ Failed'}")
    print(f"Job posting analysis: {'✅ Success' if job_posting_result and 'error' not in job_posting_result else '❌ Failed'}")
