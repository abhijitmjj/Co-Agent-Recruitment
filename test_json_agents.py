...
async def main():
    ...
    if resume_success and job_success:
        ...
        print("💡 Use these functions instead of the orchestrator agent for API responses.")
        print("\n📝 Usage examples:")
        print("```python")
        print("from co_agent_recruitment.json_agents import parse_resume_json, analyze_job_posting_json")
        print("")
