              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField control={form.control} name="skills" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., JavaScript, Management, Design" {...field} className="text-base font-code" />
                    </FormControl>
                ...
                <FormField control={form.control} name="locationPreference" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Remote, NYC, London" {...field} className="text-base" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
