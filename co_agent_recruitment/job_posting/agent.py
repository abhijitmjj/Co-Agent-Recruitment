...
class JobPosting(BaseModel): 
    ...
    company: Optional[HiringOrg] = Field(None, description="The company details, including name and description.")
...
async def analyze_job_posting(job_posting: str) ->  dict[str, Any]:
